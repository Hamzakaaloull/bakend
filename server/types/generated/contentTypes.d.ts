...
export interface ApiBrigadeBrigade extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    effectif_theorique: Schema.Attribute.Integer;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::brigade.brigade'
    ...
    publishedAt: Schema.Attribute.DateTime;
    seances: Schema.Attribute.Relation<'oneToMany', 'api::seance.seance'>;
...
export interface ApiCoursCours extends Struct.CollectionTypeSchema {
  collectionName: 'courss';
  info: {
    description: '';
    displayName: 'cours';
    pluralName: 'courss';
  ...
  attributes: {
    cour_contant: Schema.Attribute.Media<
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::cours.cours'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiInfoAppInfoApp extends Struct.CollectionTypeSchema {
  collectionName: 'info_apps';
  info: {
    displayName: 'info-app';
    pluralName: 'info-apps';
    singularName: 'info-app';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiSeanceSeance extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    Appele: Schema.Attribute.Text;
    brigade: Schema.Attribute.Relation<'manyToOne', 'api::brigade.brigade'>;
    cour: Schema.Attribute.Relation<'oneToOne', 'api::cours.cours'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    date: Schema.Attribute.Date;
    end_time: Schema.Attribute.Time;
    historique: Schema.Attribute.Relation<
      'manyToOne',
      'api::historique.historique'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    time_presence: Schema.Attribute.Time;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    user: Schema.Attribute.Relation<
...
export interface ApiUserStatusUserStatus extends Struct.CollectionTypeSchema {
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    brigade: Schema.Attribute.Relation<'oneToOne', 'api::brigade.brigade'>;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    user_status: Schema.Attribute.Relation<
      'oneToOne',
      'api::user-status.user-status'
    >;
    username: Schema.Attribute.String &
